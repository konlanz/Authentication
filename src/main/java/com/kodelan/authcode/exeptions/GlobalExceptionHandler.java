...
import static com.kodelan.authcode.exeptions.BusinessErrorCodes.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleDataDuplicationException(DataDuplicationException exp) {
        return ResponseEntity
                .status(CONFLICT)
                .body(
                        ExceptionResponse.builder()
